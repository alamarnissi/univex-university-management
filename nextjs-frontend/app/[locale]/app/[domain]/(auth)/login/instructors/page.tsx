...
const LoginInstructor = async ({params: {locale, domain}}: {params: {locale: string, domain: string}}) => {
  ...
  return (
    <div className='h-screen flex flex-col md:flex-row items-stretch'>
        ...
        <div className='md:flex-1 h-full flex justify-center items-center py-8 px-6 '>
            <LoginForm 
              title="Let&apos;s start the teaching journey !" 
              type="instructor"
              forgetPasswordUrl={`/forget-password/instructors`}
