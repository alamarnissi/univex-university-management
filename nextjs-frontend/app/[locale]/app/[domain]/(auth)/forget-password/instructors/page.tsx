...
const ForgetPasswordInstructor = async ({params: {locale, domain}}: {params: {locale: string, domain: string}}) => {
...
export default ForgetPasswordInstructor