            ...
            <Dialog as='div' onClose={() => { setModalOpenState(false) }}>
                ...
                >
                    <div className="max-w-5xl mx-auto h-full flex items-center w-full md:w-auto px-5 md:px-0">
                        <Dialog.Panel className={`relative h-max w-[600px] overflow-y-scroll no-scrollbar rounded-3xl shadow-2xl aspect-auto bg-[#F4F7FE] overflow-hidden px-10 pt-5 pb-8`}>
                            <Dialog.Title
                                as="h3"
                            ...
                            </div>
                            {
                                <div className='pt-8 pb-2 px-3 flex flex-col justify-center gap-4'>
                                    <div className='self-stretch pr-0 md:pr-5 leading'>
                                        ...
                                        <input type="text" name="title" id="title" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-900 focus-visible:outline-0" required />
                                    </div>
                                    <div className='self-stretch pr-0 md:pr-5 leading'>
                                        <label htmlFor="description" className="block mb-3 text-sm font-semibold text-gray-900 dark:text-black">
                                            Description
                                        </label>
                                        <textarea
                                            ...
                                            required
                                            maxLength={300}
                                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-900 focus:ring-0 focus:ring-offset-0 focus-visible:outline-0"
                                        >
                                        </textarea>
                                    </div>
                                    <div className='self-stretch pr-0 md:pr-5 leading'>
                                        <label htmlFor="tags" className="flex items-center gap-3 mb-3 text-sm font-semibold text-gray-900 dark:text-black">
                                            Tags
                                        </label>
                                        <TagsInputField 
                                            handleChange={() => {}}
